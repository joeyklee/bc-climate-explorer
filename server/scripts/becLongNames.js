...
let becLatest = JSON.parse(fs.readFileSync('/Users/joeyklee/Code/src/github/joeyklee/bc-climate-explorer/data/BGCunits_Ver10_2017.json'))

console.log(becLatest.length);

let becFiltered = becLatest.filter( name => ( becNames.includes(name.BGC_NoSpace) ) )

console.log(becFiltered.length)
// console.log(becFiltered)
...
let output = createDropdown(becFiltered)

fs.writeFile('/Users/joeyklee/Code/src/github/joeyklee/bc-climate-explorer/data/becNames-dropdown.html', output, function(err, data){
